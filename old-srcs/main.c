...
/*   Updated: 2021/12/01 01:50:33 by amonteli         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
void	eat(t_philo *philosopher)
{
	...
	printf("%lld %d\n", get_time() - philosopher->global->start, philosopher->global->time_to_die);
	if ((get_time() - philosopher->global->start) > philosopher->global->time_to_die)
	{
		ps_log(philosopher, A_DIE);
		exit(0);
	}
